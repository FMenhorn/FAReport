...
\tododone[inline]{Mohamed}{did proofreading}
...
\end{itemize}
\todointern[inline]{Mohamed}{Shall we add that this is calibration was proposed by us, ut others might come up with different scenarios to interpret the motion.. I mean that's not a Kinect default calibration}
