...
To build bullet, one needs cmake \cite{CMake}. After having downloaded the Bullet library from their webpage, one can follow the instructions below to build it:
\begin{enumerate}
