...
\todointern{Mohamed}{Broken reference here !! Did you mean interfaceImageProcessing instead ?}
\begin{itemize}
...
\tododone[inline]{Erik}{ proofread; Benni check if there's anything you want to add}
...
\tododone[inline]{Erik}{ did some reformulation, check again benni?}
...
\todointern[inline]{Erik}{Anyone proofread?}
...
\todointern[inline]{Erik}{Changed to past tense, please check if everything still fits!}
...
\tododone[inline]{Erik}{did minor adjustments, please check}
